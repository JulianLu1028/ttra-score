...
- 確認兩端都依梯次分段；家長端依編號排列且不顯示名次，工作人員端保留全組合併名次，頂端人數僅屬於目前項目。
