...
本賽事為單人賽。挑戰賽先在工作台選擇組別，CSV 只需「參賽編號、姓名、梯次」；系統自動帶入組別。編號採 A001＝幼兒、B001＝動力、C001＝程式、D001＝科創，各組獨立流水並檢查前綴。學科名單使用「參賽編號、姓名」。不顯示或記錄學校，匯入時拒絕額外欄位。正式資料庫初始名單為空，由主辦人匯入；虛構姓名只供自動測試使用。
